...
def generate_launch_description():
    ...
    follow_the_gap = Node(
        ...
        parameters=[
            ...
            {"gap_fallback_speed_scale": 0.55},
            {"hard_stop_distance": 0.28},
            {"front_stop_distance": 0.52},
            {"front_caution_distance": 2.00},
            {"front_window_degrees": 18.0},
            {"front_stop_percentile": 10.0},
