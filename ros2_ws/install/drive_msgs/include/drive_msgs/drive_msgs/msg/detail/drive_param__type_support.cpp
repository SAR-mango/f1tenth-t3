...
{
  new (message_memory) drive_msgs::msg::DriveParam(_init);
}

void DriveParam_fini_function(void * message_memory)
{
  auto typed_message = static_cast<drive_msgs::msg::DriveParam *>(message_memory);
  typed_message->~DriveParam();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember DriveParam_message_member_array[2] = {
  {
    "velocity",  // name
    ...
    offsetof(drive_msgs::msg::DriveParam, velocity),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(drive_msgs::msg::DriveParam, angle),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers DriveParam_message_members = {
  ...
  2,  // number of fields
  sizeof(drive_msgs::msg::DriveParam),
...
{
  return &::drive_msgs::msg::rosidl_typesupport_introspection_cpp::DriveParam_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, drive_msgs, msg, DriveParam)() {
  return &::drive_msgs::msg::rosidl_typesupport_introspection_cpp::DriveParam_message_type_support_handle;
}
