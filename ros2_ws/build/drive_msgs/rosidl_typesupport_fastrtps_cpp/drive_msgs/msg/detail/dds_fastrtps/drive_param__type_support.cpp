...
#include "drive_msgs/msg/detail/drive_param__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const drive_msgs::msg::DriveParam & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  drive_msgs::msg::DriveParam & ros_message)
{
  // Member: velocity
  cdr >> ros_message.velocity;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = drive_msgs::msg::DriveParam;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const drive_msgs::msg::DriveParam *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<drive_msgs::msg::DriveParam *>(
    untyped_ros_message);
...
{
  return &drive_msgs::msg::typesupport_fastrtps_cpp::_DriveParam__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, drive_msgs, msg, DriveParam)() {
  return &drive_msgs::msg::typesupport_fastrtps_cpp::_DriveParam__handle;
}
